// Generated from camt.056.001.11.xsd
...
pub type ExternalCancellationReason1Code = String;
...
pub type GroupCancellationIndicator = bool;
...
pub struct CancellationReason33Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalCancellationReason1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
,
    ...
    pub fi_to_fi_pmt_cxl_req:
        FIToFIPaymentCancellationRequestV11
,
}
impl Document {
    pub fn new(body: FIToFIPaymentCancellationRequestV11) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:camt.056.001.11".to_string(),
            fi_to_fi_pmt_cxl_req: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grp_cxl:
Option<        GroupCancellationIndicator
>,
    #[serde(rename = "CxlRsnInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub cxl_rsn_inf:
Vec<        PaymentCancellationReason6
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rsn:
Option<        CancellationReason33Choice
>,
    #[serde(rename = "AddtlInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub addtl_inf:
...
pub struct UnderlyingTransaction34 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_grp_inf_and_cxl:
Option<        OriginalGroupHeader21
>,
    #[serde(rename = "TxInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf:
Vec<        PaymentTransaction155
>,
}
