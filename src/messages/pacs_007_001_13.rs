// Generated from pacs.007.001.13.xsd
...
pub type ExternalReversalReason1Code = String;
...
,
    ...
    pub fi_to_fi_pmt_rvsl:
        FIToFIPaymentReversalV13
,
}
impl Document {
    pub fn new(body: FIToFIPaymentReversalV13) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pacs.007.001.13".to_string(),
            fi_to_fi_pmt_rvsl: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_grp_inf:
Option<        OriginalGroupHeader20
>,
    #[serde(rename = "TxInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf:
Vec<        PaymentTransaction149
>,
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ttl_rvsd_intr_bk_sttlm_amt:
...
pub struct ReversalReason4Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalReversalReason1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
