// Generated from camt.054.001.13.xsd
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct AccountNotification24 {
    #[serde(rename = "Id")]
    pub id:
        Max35Text
,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct BankToCustomerDebitCreditNotificationV13 {
    #[serde(rename = "GrpHdr")]
    pub grp_hdr:
        GroupHeader116
,
...
,
    ...
    pub bk_to_cstmr_dbt_cdt_ntfctn:
        BankToCustomerDebitCreditNotificationV13
,
}
impl Document {
    pub fn new(body: BankToCustomerDebitCreditNotificationV13) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:camt.054.001.13".to_string(),
            bk_to_cstmr_dbt_cdt_ntfctn: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
