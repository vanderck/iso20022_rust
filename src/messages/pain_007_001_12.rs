// Generated from pain.007.001.12.xsd
...
,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub orgnl_pmt_inf_and_rvsl:
Vec<        OriginalPaymentInstruction50
>,
...
impl Document {
    pub fn new(body: CustomerPaymentReversalV12) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pain.007.001.12".to_string(),
            cstmr_pmt_rvsl: body,
        }
    }
}
