...
pub type ExternalUnableToApplyIncorrectData1Code = String;
pub type ExternalUnableToApplyMissingData1Code = String;
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Eq, Hash)]
#[derive(Default)]
...
impl Document {
    pub fn new(body: UnableToApplyV10) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:camt.026.001.10".to_string(),
            ubl_to_apply: body,
        }
    }
}
...
pub struct IncorrectData1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalUnableToApplyIncorrectData1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
pub struct MissingData1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalUnableToApplyMissingData1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub mssng_inf:
Vec<        UnableToApplyMissing2
>,
    #[serde(rename = "IncrrctInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub incrrct_inf:
Vec<        UnableToApplyIncorrect2
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mssng_or_incrrct_inf:
Option<        MissingOrIncorrectData1
>,
    #[serde(rename = "PssblDplctInstr")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pssbl_dplct_instr:
Option<        TrueFalseIndicator
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
