// Generated from pacs.008.001.13.xsd
...
,
    ...
    pub fi_to_fi_cstmr_cdt_trf:
        FIToFICustomerCreditTransferV13
,
}
impl Document {
    pub fn new(body: FIToFICustomerCreditTransferV13) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pacs.008.001.13".to_string(),
            fi_to_fi_cstmr_cdt_trf: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub cdt_trf_tx_inf:
Vec<        CreditTransferTransaction70
>,
    #[serde(rename = "SplmtryData")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub splmtry_data:
