// Generated from camt.052.001.13.xsd
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct BankToCustomerAccountReportV13 {
    #[serde(rename = "GrpHdr")]
    pub grp_hdr:
        GroupHeader116
,
...
,
    ...
    pub bk_to_cstmr_acct_rpt:
        BankToCustomerAccountReportV13
,
}
impl Document {
    pub fn new(body: BankToCustomerAccountReportV13) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:camt.052.001.13".to_string(),
            bk_to_cstmr_acct_rpt: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
