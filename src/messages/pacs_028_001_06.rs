// Generated from pacs.028.001.06.xsd
...
,
    ...
    pub fi_to_fi_pmt_sts_req:
        FIToFIPaymentStatusRequestV06
,
}
impl Document {
    pub fn new(body: FIToFIPaymentStatusRequestV06) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pacs.028.001.06".to_string(),
            fi_to_fi_pmt_sts_req: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub orgnl_grp_inf:
Vec<        OriginalGroupInformation27
>,
    #[serde(rename = "TxInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf:
Vec<        PaymentTransaction158
>,
