// Generated from pacs.002.001.15.xsd
...
pub type ExternalPaymentGroupStatus1Code = String;
pub type ExternalPaymentTransactionStatus1Code = String;
...
pub type ExternalStatusReason1Code = String;
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Eq, Hash)]
#[derive(Default)]
...
,
    ...
    pub fi_to_fi_pmt_sts_rpt:
        FIToFIPaymentStatusReportV15
,
}
impl Document {
    pub fn new(body: FIToFIPaymentStatusReportV15) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pacs.002.001.15".to_string(),
            fi_to_fi_pmt_sts_rpt: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct FIToFIPaymentStatusReportV15 {
    #[serde(rename = "GrpHdr")]
    pub grp_hdr:
        GroupHeader120
,
...
Vec<        OriginalGroupHeader22
>,
    #[serde(rename = "TxInfAndSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf_and_sts:
Vec<        PaymentTransaction164
>,
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grp_sts:
Option<        ExternalPaymentGroupStatus1Code
>,
    #[serde(rename = "StsRsnInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub sts_rsn_inf:
Vec<        StatusReasonInformation14
>,
    #[serde(rename = "NbOfTxsPerSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub nb_of_txs_per_sts:
Vec<        NumberOfTransactionsPerStatus5
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct PaymentTransaction164 {
    #[serde(rename = "StsId")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sts_id:
Option<        Max35Text
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tx_sts:
Option<        ExternalPaymentTransactionStatus1Code
>,
    #[serde(rename = "StsRsnInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub sts_rsn_inf:
...
pub struct StatusReason6Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalStatusReason1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
