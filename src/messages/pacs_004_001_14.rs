// Generated from pacs.004.001.14.xsd
...
pub type SHA256SignatureText = String;
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Eq, Hash)]
#[derive(Default)]
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct CreditTransferTransaction68 {
    #[serde(rename = "PmtId")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pmt_id:
Option<        PaymentIdentification13
>,
    #[serde(rename = "PmtTpInf")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pmt_tp_inf:
Option<        PaymentTypeInformation28
>,
...
>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub instr_for_nxt_agt:
Vec<        InstructionForNextAgent1
>,
    #[serde(rename = "Purp")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub purp:
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct CreditTransferTransaction69 {
    #[serde(rename = "PmtId")]
    pub pmt_id:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sttlm_prty:
Option<        Priority3Code
>,
    #[serde(rename = "SttlmTmIndctn")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sttlm_tm_indctn:
Option<        SettlementDateTimeIndication1
>,
    #[serde(rename = "SttlmTmReq")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sttlm_tm_req:
Option<        SettlementTimeRequest2
>,
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub pmt_sgntr:
Option<        CryptographicKey1Choice
>,
    #[serde(rename = "PrvsInstgAgt1")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prvs_instg_agt1:
...
pub struct CryptographicKey1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ilpv4:
Option<        HexBinaryText
>,
    #[serde(rename = "Sgntr")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub sgntr:
Option<        SHA256SignatureText
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
impl Document {
    pub fn new(body: PaymentReturnV14) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pacs.004.001.14".to_string(),
            pmt_rtr: body,
        }
    }
}
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub ttl_rtrd_intr_bk_sttlm_amt:
Option<        ActiveCurrencyAndAmount
>,
    #[serde(rename = "IntrBkSttlmDt")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub intr_bk_sttlm_dt:
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct OriginalTransactionReference44 {
    #[serde(rename = "IntrBkSttlmAmt")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub intr_bk_sttlm_amt:
Option<        ActiveOrHistoricCurrencyAndAmount
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub undrlyg_cstmr_cdt_trf:
Option<        CreditTransferTransaction68
>,
    #[serde(rename = "UndrlygFICdtTrf")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub undrlyg_fi_cdt_trf:
Option<        CreditTransferTransaction69
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_grp_inf:
Option<        OriginalGroupHeader19
>,
    #[serde(rename = "TxInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf:
Vec<        PaymentTransaction163
>,
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct PaymentTransaction163 {
    #[serde(rename = "RtrId")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rtr_id:
Option<        Max35Text
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_tx_ref:
Option<        OriginalTransactionReference44
>,
    #[serde(rename = "SplmtryData")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub splmtry_data:
