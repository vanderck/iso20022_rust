// Generated from pain.002.001.14.xsd
...
Vec<        OriginalPaymentInstruction51
>,
...
,
    ...
    pub cstmr_pmt_sts_rpt:
        CustomerPaymentStatusReportV14
,
}
impl Document {
    pub fn new(body: CustomerPaymentStatusReportV14) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:pain.002.001.14".to_string(),
            cstmr_pmt_sts_rpt: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
