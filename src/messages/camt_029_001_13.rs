// Generated from camt.029.001.13.xsd
...
pub type ExternalClaimNonReceiptRejection1Code = String;
...
pub type ExternalInvestigationExecutionConfirmation1Code = String;
...
pub type ExternalPaymentCancellationRejection1Code = String;
pub type ExternalPaymentCompensationReason1Code = String;
pub type ExternalPaymentModificationRejection1Code = String;
...
pub struct CancellationStatusReason3Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalPaymentCancellationRejection1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rsn:
Option<        CancellationStatusReason3Choice
>,
...
pub struct ClaimNonReceipt3Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub accptd:
Option<        ClaimNonReceipt3
>,
    #[serde(rename = "Rjctd")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rjctd:
Option<        ClaimNonReceiptRejectReason1Choice
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
pub struct ClaimNonReceiptRejectReason1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalClaimNonReceiptRejection1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
pub struct CompensationReason1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalPaymentCompensationReason1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
pub struct CorrectiveInterbankTransaction3 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grp_hdr:
Option<        CorrectiveGroupInformation1
>,
...
pub struct CorrectiveTransaction5Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub initn:
Option<        CorrectivePaymentInitiation5
>,
    #[serde(rename = "IntrBk")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub intr_bk:
Option<        CorrectiveInterbankTransaction3
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
,
    ...
    pub rsltn_of_invstgtn:
        ResolutionOfInvestigationV13
,
}
impl Document {
    pub fn new(body: ResolutionOfInvestigationV13) -> Self {
        Self {
            xmlns: "urn:iso:std:iso:20022:tech:xsd:camt.029.001.13".to_string(),
            rsltn_of_invstgtn: body,
        }
    }
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
...
pub struct InvestigationStatus6Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub conf:
Option<        ExternalInvestigationExecutionConfirmation1Code
>,
    #[serde(rename = "RjctdMod")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rjctd_mod:
Option<Vec<        ModificationStatusReason1Choice
>>,
...
pub struct ModificationStatusReason1Choice {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub cd:
Option<        ExternalPaymentModificationRejection1Code
>,
    #[serde(rename = "Prtry")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub prtry:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rsn:
Option<        ModificationStatusReason1Choice
>,
    #[serde(rename = "AddtlInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub addtl_inf:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub grp_cxl_sts:
Option<        GroupCancellationStatus1Code
>,
    #[serde(rename = "CxlStsRsnInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub cxl_sts_rsn_inf:
Vec<        CancellationStatusReason5
>,
    #[serde(rename = "NbOfTxsPerCxlSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub nb_of_txs_per_cxl_sts:
Vec<        NumberOfTransactionsPerStatus1
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
>,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub nb_of_txs_per_cxl_sts:
Vec<        NumberOfCancellationsPerStatus1
>,
    #[serde(rename = "TxInfAndSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf_and_sts:
Vec<        PaymentTransaction153
>,
}
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, Validate)]
#[derive(Default)]
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub tx_cxl_sts:
Option<        CancellationIndividualStatus1Code
>,
    #[serde(rename = "CxlStsRsnInf")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub cxl_sts_rsn_inf:
...
>,
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_reqd_exctn_dt:
Option<        DateAndDateTime2Choice
>,
    #[serde(rename = "OrgnlReqdColltnDt")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_reqd_colltn_dt:
Option<        ISODate
>,
    #[serde(rename = "OrgnlTxRef")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
,
    ...
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub cxl_dtls:
Vec<        UnderlyingTransaction32
>,
    #[serde(rename = "ModDtls")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub mod_dtls:
Option<        PaymentTransaction157
>,
    #[serde(rename = "ClmNonRctDtls")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub clm_non_rct_dtls:
Option<        ClaimNonReceipt3Choice
>,
    #[serde(rename = "StmtDtls")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub stmt_dtls:
Option<        StatementResolutionEntry5
>,
    #[serde(rename = "CrrctnTx")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crrctn_tx:
Option<        CorrectiveTransaction5Choice
>,
    #[serde(rename = "RsltnRltdInf")]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub rsltn_rltd_inf:
...
pub struct UnderlyingTransaction32 {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub orgnl_grp_inf_and_sts:
Option<        OriginalGroupHeader23
>,
    #[serde(rename = "OrgnlPmtInfAndSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub orgnl_pmt_inf_and_sts:
Vec<        OriginalPaymentInstruction48
>,
    #[serde(rename = "TxInfAndSts")]
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
    pub tx_inf_and_sts:
Vec<        PaymentTransaction152
>,
}
